...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {
            "ryanhoangt/feeds/cambien1",
            "ryanhoangt/feeds/cambien2",
            "ryanhoangt/feeds/nutnhan1",
            "ryanhoangt/feeds/nutnhan2",
            "ryanhoangt/feeds/stage"
    };

    final String clientId = "myclientid";
    final String username = "ryanhoangt";
    final String password = "aio_vIEr87nsBGM9X3GkGZswKumf1NZa";
